...
class WalletTest (PolisTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 polis from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 polis in block rewards plus fees, but
        ...
        # Send 100 polis with subtract fee from amount
        ...
        # Sendmany 100 polis with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/polispay/polis/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
