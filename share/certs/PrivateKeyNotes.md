...
unlocked to sign the Polis-Qt.app bundle.
...
allowing somebody to distribute a Polis-Qt.app or polis-qt-setup.exe with a valid
...
that the polis-qt.exe file inside the installer had not been tampered with.
