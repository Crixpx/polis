...
class WalletTest(PolisTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 POLIS from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 POLIS with subtract fee from amount
        ...
        # Sendmany 10 POLIS with subtract fee from amount
