...
# TestNode: A peer we use to send messages to polisd, and store responses.
...
class CompactBlocksTest(PolisTestFramework):
    ...
    # This test actually causes polisd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that polisd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for polisd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # polisd will not send blocktxn responses for blocks whose height is
