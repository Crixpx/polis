...
By default, polisd will dump mempool on shutdown and
...
class MempoolPersistTest(PolisTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give polisd a second to reload the mempool
        ...
        self.log.debug("Prevent polisd from writing mempool.dat to disk. Verify that `savemempool` fails")
