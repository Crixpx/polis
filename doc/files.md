...
* polis.conf: contains configuration settings for polisd or polis-qt
* polisd.pid: stores the process id of polisd while running
...
* debug.log: contains debug information and general logging generated by polisd or polis-qt
