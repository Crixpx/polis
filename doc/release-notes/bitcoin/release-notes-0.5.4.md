Polis version 0.5.4 is now available for download at:
http://sourceforge.net/projects/polis/files/Polis/polis-0.5.4/
...
http://gitorious.org/polispay/polisd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Polis-Qt notifications under Growl 1.3.
Increase required age of Polis-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxPolis properly when installing Polis-Qt over it. (Windows)
