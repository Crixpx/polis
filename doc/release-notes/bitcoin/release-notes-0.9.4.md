Polis Core version 0.9.4 is now available from:

  https://polis.org/bin/0.9.4/
...
this update is incompatible with the Polis system and could lead to consensus
forks.

Polis Core released binaries from https://polis.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~polis/+archive/ubuntu/polis
- A third-party or self-compiled Polis Core

upgrade to Polis Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
