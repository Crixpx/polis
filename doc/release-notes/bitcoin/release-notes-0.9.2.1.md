Polis Core version 0.9.2.1 is now available from:

  https://polis.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 POLIS to 0.01 POLIS
...
- Fix "Start polis on system login"
