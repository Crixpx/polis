Polis-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/polis/files/Polis/polis-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Polis
...
New/changed settings (command-line or polis.conf file)
--------------------------------------------------------
