Polis Core version 0.10.4 is now available from:

  <https://polis.org/bin/polis-core-0.10.4/>
...
- #6953 `43c2789` Split polis-tx into its own package
- #6953 `dfe0d4d` Include polis-tx binary on Debian/Ubuntu
