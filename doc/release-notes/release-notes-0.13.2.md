Polis Core version 0.13.2 is now available from:

  <https://polis.org/bin/polis-core-0.13.2/>
...
- #8908 `4a974b2` Update polis-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow polis-tx to create v2 transactions (btcdrak)
