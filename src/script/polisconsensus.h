...
typedef enum polisconsensus_error_t
{
    ...
    polisconsensus_ERR_AMOUNT_REQUIRED,
...
enum
{
    ...
    polisconsensus_SCRIPT_FLAGS_VERIFY_WITNESS             = (1U << 11), // enable WITNESS (BIP141)
    polisconsensus_SCRIPT_FLAGS_VERIFY_ALL                 = polisconsensus_SCRIPT_FLAGS_VERIFY_P2SH | polisconsensus_SCRIPT_FLAGS_VERIFY_DERSIG |
                                                               ...
                                                               polisconsensus_SCRIPT_FLAGS_VERIFY_CHECKSEQUENCEVERIFY | polisconsensus_SCRIPT_FLAGS_VERIFY_WITNESS
};
...
EXPORT_SYMBOL int polisconsensus_verify_script_with_amount(const unsigned char *scriptPubKey, unsigned int scriptPubKeyLen, int64_t amount,
                                    const unsigned char *txTo        , unsigned int txToLen,
                                    unsigned int nIn, unsigned int flags, polisconsensus_error* err);
