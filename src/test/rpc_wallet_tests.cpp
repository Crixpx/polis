...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CPolisAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CPolisAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey(0, false);
        demoAddress = CPolisAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CPolisAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CPolisAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CPolisAddress(arr[0].get_str()).Get() == demoAddress.Get());
