...
{
    BOOST_CHECK(TestSplitHost("www.polis.org", "www.polis.org", -1));
    BOOST_CHECK(TestSplitHost("[www.polis.org]", "www.polis.org", -1));
    BOOST_CHECK(TestSplitHost("www.polis.org:80", "www.polis.org", 80));
    BOOST_CHECK(TestSplitHost("[www.polis.org]:80", "www.polis.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:24216", "127.0.0.1", 24216));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:24216", "127.0.0.1", 24216));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:24216", "::ffff:127.0.0.1", 24216));
    BOOST_CHECK(TestSplitHost("[::]:24216", "::", 24216));
    BOOST_CHECK(TestSplitHost("::24216", "::24216", -1));
    BOOST_CHECK(TestSplitHost(":24216", "", 24216));
    BOOST_CHECK(TestSplitHost("[]:24216", "", 24216));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:24216", "127.0.0.1:24216"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:24216", "[::]:24216"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
