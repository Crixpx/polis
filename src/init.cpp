 ...
 * between polisd, and polis-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/polispay/polis>";
    const std::string URL_WEBSITE = "<https://polispay.org>";
...
/** Sanity checks
 *  Ensure that Polis is running in a usable environment with all
...
{
    // Make sure only a single Polis process is using the data directory.
...
bool AppInitMain()
{
    ...
    if (gArgs.IsArgSet("-datadir") && !fs::path(gArgs.GetArg("-datadir", "")).is_absolute()) {
        LogPrintf("Warning: relative datadir option '%s' specified, which will be interpreted relative to the "
                  "current working directory '%s'. This is fragile, because if polis is started in the future "
                  "from a different location, it will be unable to locate the current data files. There could "
                  "also be data loss if polis is started while in a temporary directory.\n",
