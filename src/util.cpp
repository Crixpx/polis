...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Polis
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Polis
    // Mac: ~/Library/Application Support/Polis
    // Unix: ~/.polis
#ifdef WIN32
    // Windows
...
void ArgsManager::ReadConfigFile(const std::string& confPath)
{
    ...
    if (!streamConfig.good())
        return; // No polis.conf file is OK
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Check for untranslated substitution to make sure Polis Core copyright is not removed by accident
    if (strprintf(COPYRIGHT_HOLDERS, COPYRIGHT_HOLDERS_SUBSTITUTION).find("Polis Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Polis Core developers";
    }
