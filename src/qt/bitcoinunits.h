...
*/
class PolisUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit PolisUnits(QObject *parent);

    /** Polis units.
      @note Source: https://en.polis.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        POLIS,
...
typedef PolisUnits::Unit PolisUnit;
