...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<PolisAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_polis-qt -platform xcb      # Linux
//     src/qt/test/test_polis-qt -platform windows  # Windows
//     src/qt/test/test_polis-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = PolisUnits::formatWithUnit(unit, balance, false, PolisUnits::separatorAlways);
    ...
    // Amount input
    PolisAmountField* amountInput = receiveCoinsDialog.findChild<PolisAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: polis:")) != -1);
