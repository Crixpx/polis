...
Files used during the gitian build process. For more information about gitian, see the [the Polis Core documentation repository](https://github.com/polis-core/docs).

### [Gitian-keys](/contrib/gitian-keys)
PGP keys used for signing Polis Core [Gitian release](/doc/release-process.md) results.

### [MacDeploy](/contrib/macdeploy) ###
Scripts and notes for Mac builds. 

### [RPM](/contrib/rpm) ###
RPM spec file for building polis-core on RPM based distributions.
...
This script attempts to download and verify the signature file SHA256SUMS.asc from polis.org.
