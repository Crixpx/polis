...
%{_sbindir}/semanage port -a -t polis_port_t -p tcp 24217
%{_sbindir}/semanage port -a -t polis_port_t -p tcp 24216
%{_sbindir}/semanage port -a -t polis_port_t -p tcp 124217
%{_sbindir}/semanage port -a -t polis_port_t -p tcp 124216
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 24217
	%{_sbindir}/semanage port -d -p tcp 24216
	%{_sbindir}/semanage port -d -p tcp 124217
	%{_sbindir}/semanage port -d -p tcp 124216
